...
if __name__ == "__main__":
    ...
    dcm_file_path = "IM-0003-0022.dcm"
    json_file_path = "responses/response2.json"
    ...
    for data in report.split(('\n')):
        ...
        data = data.replace('"', '\\"')
        if data in fhir_msg:
            fhir_msg = fhir_msg.replace(data, "", 1)
        else:
            print("Not found in FHIR message:", data)
            print("FHIR message missing complete SR report data")
            exit()

    print("Validation Complete! \nFHIR data contains complete SR report data")
